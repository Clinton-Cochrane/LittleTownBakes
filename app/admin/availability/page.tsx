	...
	return (
		<main className="mx-auto max-w-3xl px-4 py-6">
			...
			<section className="card-warm mb-8 p-6 sm:p-8">
				<h2 className="mb-4 font-display text-lg font-semibold text-cocoa">Add or update availability</h2>
			...
			<section>
				<h2 className="mb-4 font-display text-lg font-semibold text-cocoa">Current availability</h2>
				{slots.length === 0 ? (
